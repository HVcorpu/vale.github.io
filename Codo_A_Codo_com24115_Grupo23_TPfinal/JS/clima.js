...
function obtenerDatos() {
    ...
    const apiKey = '51dcfa8eccedea39e45acbe804fb55ed';
    //al final de la url después del signo igual = poner la key provista por openweather
    const url ='http://api.openweathermap.org/data/2.5/weather?q=Buenos%20Aires,AR&lang=es&units=metric&appid='+ apiKey;
